...
local CrucifixTool = game:GetObjects("rbxassetid://11947753903")[1]
CrucifixTool.Name = "Ambush Crucifix"
...
local function func(ins)
    ...
    if ins:GetAttribute("IsCustomEntity")==true and ins:GetAttribute("ClonedByCrucifix")~=true then
        local Chains = game:GetObjects("rbxassetid://11947772509")[1]
...
dupeCrucifix.Event:Connect(function(time, entityRoot)
    local Cross = game:GetObjects("rbxassetid://11947753903")[1]
