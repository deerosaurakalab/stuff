...
local CrucifixTool = game:GetObjects("rbxassetid://11902676626")[1]
CrucifixTool.Name = "Spongebob Crucifix"
...
local function func(ins)
    ...
    if ins:GetAttribute("IsCustomEntity")==true and ins:GetAttribute("ClonedByCrucifix")~=true then
        local Chains = game:GetObjects("rbxassetid://11902829692")[1]
...
dupeCrucifix.Event:Connect(function(time, entityRoot)
    local Cross = game:GetObjects("rbxassetid://11902676626")[1]
