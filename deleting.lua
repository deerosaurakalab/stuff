...
local CrucifixTool = game:GetObjects("rbxassetid://11922862297")[1]
CrucifixTool.Name = "cheese crucifix"
...
local function func(ins)
    ...
    if ins:GetAttribute("IsCustomEntity")==true and ins:GetAttribute("ClonedByCrucifix")~=true then
        local Chains = game:GetObjects("rbxassetid://11922967986")[1]
...
dupeCrucifix.Event:Connect(function(time, entityRoot)
    local Cross = game:GetObjects("rbxassetid://11922862297")[1]
